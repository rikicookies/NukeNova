...
final class StatisticsModule implements ModuleInterface
{
    ...
    {
        $context->events->listen(\NovaNuke\Core\Events\EventName::ADMIN_MENU_BUILDING,static function(object $e):void{if($e instanceof AdminMenuBuilding)$e->add('Statistics','/admin/statistics','statistics.view-admin');});$context->events->listen(\NovaNuke\Core\Events\EventName::BLOCK_RENDERING,static function(object $e)use($context):void{if(!$e instanceof BlockRendering||$e->block['type']!=='statistics-summary')return;$e->render($context->container->get(ViewRenderer::class)->render('@statistics/block.twig',['summary'=>$context->container->get(StatisticsRepository::class)->summary()]));});$context->events->listen(\NovaNuke\Core\Events\EventName::MAINTENANCE_PRUNING,static function(object $e)use($context):void{if($e instanceof MaintenancePruning)$e->add('statistics.daily',$context->container->get(StatisticsRepository::class)->prune($e->dryRun));});
